...
for wiki_url in wikiurls: 
    ...
    greek_names3=re.findall(r'Greek</a>.*?<a',characters)
    greek_names4=re.findall(r'Gr.</a>.*?<i>',characters)
    greek_names5=re.findall(r'comes directly from Ancient Greek ".*?",',characters)
    greek_names6=re.findall(r'</span></span>;.*?protectress"',characters)
    text=re.sub(r'<.*?>', "", greek_names)
